/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c688b4b19fe431f3ed9cf5a201a9b86f)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		ASSETS: Fetcher;
		PUBLIC_AUTH_URL: "http://localhost:4321";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_AUTH_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "ALLOWED_EMAILS" | "GITHUB_TOKEN" | "GITHUB_REPO" | "GITHUB_BRANCH">> {}
}
